...
const Magazine = () => {
  return (
    <div>
      <h4 className="text-left p-5 pl-7 mobile-padding" style={{ fontFamily: 'FranklinGothic URW', color: '#6ac9cb', fontSize: '18px' }}>
        Graphic Designer, Illustrator, and Web Designer based in Cleveland, OH.
      </h4>
      <div className="columns-1 p-10 m-10 mobile-padding">
