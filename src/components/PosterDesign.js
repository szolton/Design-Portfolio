  ...
  return (
    <div>
      ...
      <div className="columns-1 p-10 m-10">
        ...
        <img src={halloweenSign} className="w-300 h-200 object-cover rounded shadow-md" alt="embassy halloween illustration sign" />
        ...
        <img src={yardSigns} className="w-300 h-200 object-cover rounded shadow-md" alt="embassy halloween illustration sign" />

        {/* Paramore Columbus poster */}
        <img src={paramorePoster} className="w-300 h-200 object-cover rounded shadow-md mt-5" alt="paramore columbus poster" />
        ...
        {/* Cedar Point poster */}
        <img src={cedarPoster} className="w-300 h-200 object-cover rounded shadow-md mt-5" alt="cedar point photo collage illustration" />
        <p className="mb-3 text-center text-gray-600 mt-2">
          An illustrative Photoshop Poster Design for Cedar Fair.
        </p>

        {/* Agora building drawing */}
        <img src={agoraMockup} className="w-300 h-200 object-cover rounded shadow-md mt-5" alt="the agora building illustration" />
        <p className="mb-3 text-center text-gray-600 mt-2">
          An illustrative Poster Design Advertisement for The Agora in Cleveland.
        </p>

        {/* Cleveland screenprint mockup */}
        <img src={screenprintMockup} className="w-300 h-200 object-cover rounded shadow-md mt-5" alt="cle screenprint mockup" />
        <p className="mb-3 text-center text-gray-600 mt-2">
